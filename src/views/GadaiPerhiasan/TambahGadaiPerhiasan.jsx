...
const TambahGadaiPerhiasanPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Endpoint berbeda untuk checker
      const urlSubmit = userRole === "checker" ? "/checker/gadai-perhiasan" : "/gadai-perhiasan";
    ...
    <Card sx={{ p:2 }}>
      ...
      <CardContent>
        <Grid container spacing={2}>
          ...
          {/* Jenis Perhiasan */}
          <Grid item xs={12} sm={6}>
            <TextField label="Jenis Perhiasan" name="type_perhiasan" value={form.type_perhiasan} onChange={handleChange} fullWidth size="small"/>
          </Grid>
        ...
        <Stack direction="row" justifyContent="flex-end" spacing={2} sx={{mt:4}}>
          <Button variant="outlined" onClick={()=>navigate("/gadai-perhiasan")}>Batal</Button>
