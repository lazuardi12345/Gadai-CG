...
const getApiUrlById = (resource, role, id) => {
  switch (role) {
    case "petugas": return `/petugas/${resource}/${id}`;
    case "checker": return `/checker/${resource}/${id}`;
      ...
      <Paper elevation={2} sx={{ position: "sticky", top: 16, zIndex: 20, borderRadius: 3, mb: 3 }}>
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", px: 3, py: 2 }}>
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Box>
              <Typography variant="h6" fontWeight={700}>Detail Gadai Perhiasan</Typography>
            ...
            <Stack spacing={2} alignItems="center">
              ...
              <Stack spacing={1} sx={{ width: "100%" }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography variant="subtitle2" color="text.secondary">Tipe Perhiasan</Typography>
                  <Typography variant="subtitle2" fontWeight={700}>{d.type_perhiasan || '-'}</Typography>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
