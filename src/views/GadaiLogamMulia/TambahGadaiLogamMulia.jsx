...
const TambahGadaiLogamMuliaPage = () => {
    ...
    // Ambil data detail gadai (untuk pilih nasabah)
    useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            setSaving(true);
            const res = await axiosInstance.post('/gadai-logam-mulia', form);
            if (res.data.success) {
        ...
        <Card sx={{ p: 2 }}>
            ...
            <CardContent>
                            ...
                            <Grid item xs={12} sm={6} key={key}>
                                <TextField
                                    label={key
                                        ...
                                        .replace('Logam Mulia', 'Logam Mulia')}
                                    name={key}
                                    value={form[key]}
                ...
                <Stack direction="row" justifyContent="flex-end" spacing={2} sx={{ mt: 4 }}>
                    <Button variant="outlined" onClick={() => navigate('/gadai-logam-mulia')}>
                        Batal
                    </Button>
                    <Button
                        variant="contained"
