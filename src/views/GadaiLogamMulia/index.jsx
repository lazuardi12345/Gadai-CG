        ...
        >
          ...
          >
            <TableHead>
              <TableRow>
                {[
                  'No', 'Nama Barang', 'Kode Cap', 'Karat',
                  'Berat', 'Potongan Batu', 'Kelengkapan',
                  'Nasabah', 'Aksi'
                ].map(head => (
                  <TableCell
                    key={head}
                    ...
                    <Stack direction="row" spacing={1} justifyContent="center">
                      <Tooltip title="Detail">
                        <IconButton size="small" color="info"
                          onClick={() => navigate(`/detail-gadai-logam-mulia/${item.id}`)}>
                      ...
                      {["hm", "checker"].includes(userRole) && (
                        <Tooltip title="Edit">
                          <IconButton size="small" color="primary"
                            onClick={() => navigate(`/edit-gadai-logam-mulia/${item.id}`)}>
