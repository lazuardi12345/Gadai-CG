...
const PelelanganPage = () => {
    ...
    const getApiUrl = (isPost = false) => {
        ...
        // Jika tabIndex = 1, ambil history
        if (!isPost && tabIndex === 1) return `${baseUrl}/history`;
        return baseUrl;
    };
    ...
    const handleSubmitLelang = async () => {
        ...
        try {
            ...
            if (res.data.success) {
                ...
                handleCloseModal();
                // Hapus item dari list tanpa fetch ulang
